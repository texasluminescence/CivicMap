...
export const ArrowLeftIcon: FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg 
      className={className} 
...
export const LocationIcon: FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
export const TimeIcon: FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
export const SearchIcon: FC<IconProps> = ({ size = 20, className = "" }) => (
...
export const SlidersIcon: FC<IconProps> = ({ size = 20, className = "" }) => (
...
export const CompassIcon: FC<IconProps> = ({ className = "w-7 h-7" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
export const UserIcon: FC<IconProps> = ({ className = "w-7 h-7" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
export const StarIcon: FC<StarIconProps> = ({ isStarred = false, className }) => (
  <Star
    className={className}
    fill={isStarred ? "#e6b800" : "none"}
    stroke={isStarred ? "#e6b800" : "currentColor"}
    strokeWidth={2}
  />
);
